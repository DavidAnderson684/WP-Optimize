...
<div class="wpo_section wpo_group">
	<form onSubmit="return confirm('Did you make a database backup? There is no Undo option')" action="#" method="post" enctype="multipart/form-data" name="optimize_form" id="optimize_form">
